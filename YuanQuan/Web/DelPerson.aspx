<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DelPerson.aspx.cs" Inherits="Web.DelPerson" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <asp:Label ID="Label1" runat="server" BackColor="White" Text="输入要删除的个人ID："></asp:Label>
        <br />
        <br />
