<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DelAdmin.aspx.cs" Inherits="Web.DelAdmin" %>
...
<body>
     ...
     <form id="form1" runat="server">
        ...
        <br />
        <asp:Label ID="Label1" runat="server" BackColor="White" Text="输入要删除的管理员ID："></asp:Label>
        <br />
        <br />
